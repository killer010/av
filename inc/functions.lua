...
var =  'المبرمج كيلر'
elseif redis:sismember(av..':SUDO_BOT:',UserID) then
var = 'مطور البوت' 
elseif redis:sismember(av..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(av..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء' 
elseif redis:sismember(av..'owners:'..ChatID,UserID) then
var = 'مدير البوت' 
elseif redis:sismember(av..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت' 
elseif redis:sismember(av..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز' 
else
var = 'فقط عضو' 
end
...
if msg.edited then
redis:incr(av..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(av..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(av..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(av..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(av..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(av..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(av..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(av..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(av..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(av..':SUDO_BOT:')
message = '❃ ** قائمه الـمـطـوريـن : \n\n`❃ مطور اساسي`**\n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*———————————————— *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n .*"
else
for k,v in pairs(list) do
local info = redis:hgetall(av..'username:'..v)
local count = redis:scard(av..'mtwr_count'..v)
...
local monsha = redis:smembers(av..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————— \n\n❃ قائمه المدراء :*\n\n'
local list = redis:smembers(av..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(av..'admins:'..msg.chat_id_)
...
local list = redis:smembers(av..'whitelist:'..msg.chat_id_)
...
if redis:sismember(av..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(av..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(av..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(av..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(av..'gban_users')
...
local list = redis:smembers(av..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(av..':Filter_Word:'..msg.chat_id_,word) then 
return  "❃ **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع ." 
else
redis:sadd(av..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(av..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(av..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(av..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(av..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(av..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(av..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local list = redis:smembers(av..'group:ids')
message = '❃ **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(av..'group:name'..v)
if info then 
...
<link href="https://fonts.avapis.com/css?family=Harmattan" rel="stylesheet">
...
redis:del(
av..'group:add'..id_group,
av..'lock_link'..id_group, 
av..'lock_id'..id_group,
av..'lock_spam'..id_group, 
av..'lock_webpage'..id_group,
av..'lock_markdown'..id_group,
av..'lock_flood'..id_group,
av..'lock_bots'..id_group,
av..'mute_forward'..id_group,
av..'mute_contact'..id_group,
av..'mute_location'..id_group,
av..'mute_document'..id_group,
av..'mute_keyboard'..id_group,
av..'mute_game'..id_group,
av..'mute_inline'..id_group,
av..'lock_username'..id_group,
av..'num_msg_av'..id_group,
av..'replay'..id_group
)
redis:srem(av..'group:ids',id_group)
end
...
redis:hset(av..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(av..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(av..'group:add'..msg.chat_id_) then  return '❃ **المجموعة تم تفعيلها مُسبقاً . ' end
...
redis:setex(av..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(av..':addnumberusers') or 0)
...
local lock_service = redis:get(av..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(av..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(av..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
av..'group:add'..msg.chat_id_,true,
av..'lock_link'..msg.chat_id_,true, 
av..'lock_id'..msg.chat_id_,true,
av..'lock_spam'..msg.chat_id_,true,
av..'lock_webpage'..msg.chat_id_,true,
av..'lock_markdown'..msg.chat_id_,true,
av..'lock_flood'..msg.chat_id_,true,
av..'lock_bots'..msg.chat_id_,true,
av..'mute_forward'..msg.chat_id_,true,
av..'mute_contact'..msg.chat_id_,true,
av..'mute_location'..msg.chat_id_,true,
av..'mute_document'..msg.chat_id_,true,
av..'mute_keyboard'..msg.chat_id_,true,
av..'mute_game'..msg.chat_id_,true,
av..'mute_inline'..msg.chat_id_,true,
av..'lock_username'..msg.chat_id_,true,
av..'num_msg_av'..msg.chat_id_,5, 
av..'replay'..msg.chat_id_,true
)

redis:sadd(av..'group:ids',msg.chat_id_) 
redis:sadd(av..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(av..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(av..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(av..'group:add'..msg.chat_id_) then return '** المجموعه تم تعطيلها مُسبقاً .' end  
...
if redis:sismember(av..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(av..'username:'..UserID,'username',Resolv)
redis:sadd(av..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ تمت ترقيته ليصبح منشىء \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(av..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(av..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(av..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(av..'username:'..UserID,'username',Resolv)
redis:sadd(av..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ تمت ترقيته ليصبح منشىء اساسي \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(av..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(av..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(av..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(av..'username:'..UserID, 'username', Resolv)
redis:sadd(av..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(av..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(av..'whitelist:'..ChatID,UserID)
...
if redis:sismember(av..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(av..'username:'..UserID, 'username', Resolv)
redis:sadd(av..'owners:'..ChatID,UserID)
...
if redis:sismember(av..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(av..'username:'..UserID, 'username', Resolv)
redis:sadd(av..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(av..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(av..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(av..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(av..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(av..'msgs:'..UserID..':'..ChatID) or 1
...
redis:hset(av..'username:'..UserID, 'username', Resolv)
redis:sadd(av..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ تم حظره  \n',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(av..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ تم بالتأكيد الغاء حظره  \n',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ تم الغاء حظره \n',17,USERCAR) 
end
redis:srem(av..'banned:'..ChatID,UserID)
...
if redis:sismember(av..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ تم بالتأكيد كتمه  \n',17,USERCAR) 
end
redis:hset(av..'username:'..UserID, 'username', Resolv)
redis:sadd(av..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ تم كتمه \n',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(av..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ تم بالتاكيد الغاء كتمه  \n',17,USERCAR) 
end
redis:srem(av..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ تم الغاء كتمه  \n',17,USERCAR) 
end
...
redis:hset(av..'username:'..UserID, 'username',Resolv)
redis:sadd(av..'gban_users',UserID)
...
redis:srem(av..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ تم الغاء حظره العام \n',17,USERCAR) 
end
...
if redis:sismember(av..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ انه بالتأكيد مطور \n',17,USERCAR) 
end
redis:hset(av..'username:'..UserID, 'username', Resolv)
redis:sadd(av..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ تم ترقيته ليصبح مطور \n',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(av..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ انه بالتأكيد ليس مطور \n',17,USERCAR) 
end
redis:srem(av..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ تم تنزيله من المطور \n',17,USERCAR) 
end  -- End Cmd 
end,nil)
else
...
redis:hset(av..'username:'..UserID, 'username', UserName)
redis:sadd(av..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(av..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'❃ **العضو » ❪ '..UserName..' ❫\n❃ **الايدي » ❪ `'..UserID..'` ❫\n❃ **تم بالتأكيد حظره \n') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
return sendMsg(ChatID,MsgID,"❃ **لا يمكنك طرد المطور\n") 
elseif
redis:sismember(av..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"❃ **لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(av..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"❃ **لا يمكنك طرد المدير\n") 
elseif redis:sismember(av..'admins:'..ChatID,UserID) then 
...
Restrict(ChatID,UserID,1)
redis:hset(av..'username:'..UserID, 'username', Resolv)
redis:sadd(av..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ تم تقييد آلعضـو بنجاح \n',17,USERCAR) 
end 
if cmd =="fktqeed" then
  Restrict(ChatID,UserID,2)
  redis:srem(av..':tqeed:'..ChatID,UserID)
...
if cmd == "dn_sudo" then
if not redis:sismember(av..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'❃ **العضو » '..USERNAME..' \n❃ ** الايدي » (`'..UserID..'`)\n❃ **انه بالتأكيد ليس مطور \n') end
redis:srem(av..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'❃ العضو » ❪ '..USERNAME..' ❫\n❃ الايدي » ❪ '..UserID..' ❫\n❃ تم تنزيله من المطور \n',17,USERCAR) 
end
...
if redis:get(av..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(av..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(av..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(av..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*❃*` اعدادات المجموعه :` \n"
.."\n❃ التعديل «» "..(redis:get(av..'lock_edit'..msg.chat_id_) or 'false')
.."\n❃ الروابط «» "..(redis:get(av..'lock_link'..msg.chat_id_) or 'false')
.."\n❃ التاك «» "..(redis:get(av..'lock_tag'..msg.chat_id_) or 'false')
.."\n❃ المعرفات «» "..(redis:get(av..'lock_username'..msg.chat_id_) or 'false')
.."\n❃ التكرار «» "..(redis:get(av..'lock_flood'..msg.chat_id_) or 'false')
.."\n❃ الكلايش «» "..(redis:get(av..'lock_spam'..msg.chat_id_) or 'false')
.."\n❃ الويب «» "..(redis:get(av..'lock_webpage'..msg.chat_id_) or 'false')
.."\n❃ الماركدوان «» "..(redis:get(av..'lock_markdown'..msg.chat_id_) or 'false')
.."\n❃ بالطرد البوتات «» "..(redis:get(av..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n❃ البوتات «» "..(redis:get(av..'lock_bots'..msg.chat_id_) or 'false')
.."\n❃ عدد التكرار «» "..(redis:get(av..'num_msg_av'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n❃`اعدادات الوسائط :`\n"
.."\n*❃ *المتحركه «» "..(redis:get(av..'mute_gif'..msg.chat_id_) or 'false')
.."\n❃ الدردشه «» "..(redis:get(av..'mute_text'..msg.chat_id_) or 'false')
.."\n❃ الانلاين «» "..(redis:get(av..'mute_inline'..msg.chat_id_) or 'false')
.."\n❃ الالعاب «» "..(redis:get(av..'mute_game'..msg.chat_id_) or 'false')
.."\n❃ الصور «» "..(redis:get(av..'mute_photo'..msg.chat_id_) or 'false')
.."\n❃ الفيديو «» "..(redis:get(av..'mute_video'..msg.chat_id_) or 'false')
.."\n❃ البصمات «» "..(redis:get(av..'mute_audio'..msg.chat_id_) or 'false')
.."\n❃ الصوت «» "..(redis:get(av..'mute_voice'..msg.chat_id_) or 'false')
.."\n❃ الملصقات «» "..(redis:get(av..'mute_sticker'..msg.chat_id_) or 'false')
.."\n❃ الجهات «» "..(redis:get(av..'mute_contact'..msg.chat_id_) or 'false')
.."\n❃ التوجيه «» "..(redis:get(av..'mute_forward'..msg.chat_id_) or 'false')
.."\n❃ الموقع «» "..(redis:get(av..'mute_location'..msg.chat_id_) or 'false')
.."\n❃ الملفات «» "..(redis:get(av..'mute_document'..msg.chat_id_) or 'false')
.."\n❃ الاشعارات «» "..(redis:get(av..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n❃ الكيبورد «» "..(redis:get(av..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*❃*`اعدادات اخرى : `"
.."\n\n*❃*الترحيب «» "..welcomex
.."\n*❃*الردود «» "..replayx
...
.."\n*❃*الويب «» "..(redis:get(av..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*❃*الماركدوان «» "..(redis:get(av..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*❃*البوتات بالطرد «» "..(redis:get(av..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*❃*البوتات «» "..(redis:get(av..'lock_bots'..msg.chat_id_) or 'false')
.."\n*❃*عدد التكرار «» "..(redis:get(av..'num_msg_av'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*❃*اعدادات التقـييد :\n"
.."\n*❃*التقييد بالتوجيه «» "..(redis:get(av..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*❃*التقييد بالصور «» "..(redis:get(av..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*❃*التقييد بالروابط «» "..(redis:get(av..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*❃*التقييد بالمتحركه «» "..(redis:get(av..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*❃*التقييد الفيديو «» "..(redis:get(av..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
