...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/mohamed2512000/avfile/main/GetVersion.txt' ) or 0
...
return '❃ اصدار سورس ايف : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'❃ ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس ايف يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
send_key(msg.sender_user_id_,'   [قناة سورس : ايف](https://t.me/Av_bot1)' ,nil,inline,msg.id_)
return false
end
...
𝙲𝙷 𖣲. :[SOURCE AV𖠉𖡶 ](https://t.me/Av_bot1)
]]
end
...
return '❃ **عدد تعديلاتك ⇜ ❪ '..(redis:get(av..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n'
end
...
elseif Text== "مالك" or Text== "محمد" then return  sendMsg(msg.chat_id_,msg.id_,"[مالك سورس ايـف↯](https://t.me/mo_7_med)")
elseif Text== "بطه" or Text== "بطه" then return  sendMsg(msg.chat_id_,msg.id_,"[مالكه سورس ايـف](https://t.me/Vlllll7)")
elseif Text== "سورس ايف" or Text== "سورس ايف" then return  sendMsg(msg.chat_id_,msg.id_,"[احسن سورس مصري ↯](https://t.me/Av_bot1)")
...
elseif Text:match(Bot_Name.."كيفك") then 
  ...
  elseif Text== "ارض زيكولا"  then return sendMsg(msg.chat_id_,msg.id_,"[ارض زيكولا  𖡼](https://t.me/SOURCE_AV/3.")
  elseif Text== "مقبره الحيوانات."  then return sendMsg(msg.chat_id_,msg.id_," [مقبره الحيوانات 𖡼](https://t.me/SOURCE_AV/8)")
  elseif Text== "التحرر"  then return sendMsg(msg.chat_id_,msg.id_,"[التحرر  𖡼](https://t.me/SOURCE_AV/9)")
  elseif Text== "روايه المخلوق"  then return sendMsg(msg.chat_id_,msg.id_,"[روايه المخلوق  𖡼](https://t.me/SOURCE_AV/5)")
  elseif Text== "في حضره الجن"  then return sendMsg(msg.chat_id_,msg.id_,"[في حضره الجن  𖡼](https://t.me/SOURCE_AV/6).")
  elseif Text== "موسوعه الظلام"  then  return sendMsg(msg.chat_id_,msg.id_,"[موسوعه الظلام  𖡼](https://t.me/SOURCE_AV/4)."  )
  elseif Text== "لقاء مع كاتب الرعب"  then return sendMsg(msg.chat_id_,msg.id_,"[لقاء مع كاتب الرعب  𖡼](https://t.me/SOURCE_AV/7) .")
  ...
  elseif Text== "هيه"  then return sendMsg(msg.chat_id_,msg.id_,"وبعدين" )
    elseif Text== "ما تخبئه لنا النجوم"  then return sendMsg(msg.chat_id_,msg.id_,"[ما تخبئه لنا النجوم  𖡼](https://t.me/SOURCE_AV/18).")
  elseif Text== "بعد النسيان."  then return sendMsg(msg.chat_id_,msg.id_," [بعد النسيان  𖡼](https://t.me/SOURCE_AV/19)  ")
  elseif Text== "يوميات كئيب"  then return sendMsg(msg.chat_id_,msg.id_,"[يوميات كئيب  𖡼](https://t.me/SOURCE_AV/20)")
  elseif Text== "الشفق"  then return sendMsg(msg.chat_id_,msg.id_,"[روايه الشفق الجزء الاول  𖡼](https://t.me/SOURCE_AV/21)")
  elseif Text== "كبرياء وتحمل"  then return sendMsg(msg.chat_id_,msg.id_,"[كبرياء وتحمل  𖡼](https://t.me/SOURCE_AV/22).")
  elseif Text== "الامير السعيد"  then  return sendMsg(msg.chat_id_,msg.id_,"[الامير السعيد  𖡼](https://t.me/SOURCE_AV/23)."  )
  elseif Text== "الانسان الاخير"  then return sendMsg(msg.chat_id_,msg.id_,"[الانسان الاخير  𖡼](https://t.me/SOURCE_AV/24) .")
  ...
  elseif Text== "واختفي كل شئ"  then return sendMsg(msg.chat_id_,msg.id_,"[واختفي كل شئ  𖡼](https://t.me/SOURCE_AV/37)")
  elseif Text== "جثه في الخندق"  then return sendMsg(msg.chat_id_,msg.id_," [جثة في الخندق  𖡼](https://t.me/SOURCE_AV/37) ")
  elseif Text== "اللوح الازرق"  then return sendMsg(msg.chat_id_,msg.id_,"[اللوح الازرق  𖡼](https://t.me/SOURCE_AV/35)")
  elseif Text== "نيلوفر الاسود"  then return sendMsg(msg.chat_id_,msg.id_,"[نيلوفر الاسود  𖡼](https://t.me/SOURCE_AV/34)")
  elseif Text== "في القطار السعيد"  then return sendMsg(msg.chat_id_,msg.id_,"[في القطار السريع  𖡼](https://t.me/SOURCE_AV/33).")
  elseif Text== "الرمز المفقود"  then  return sendMsg(msg.chat_id_,msg.id_,"[الرمز المفقود  𖡼](https://t.me/SOURCE_AV/32)."  )
